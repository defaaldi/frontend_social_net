    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        const request = await fetch(
          Global.url + "publication/delete-publication/" + publicationId,
          {
            method: "DELETE",
            headers: {
            ...
            >
              <div className="post__container">
                <div className="post__image-user">
                  <Link
                    to={`/rsocial/perfil/${publication.user_id._id}`}
                    className="post__image-link"
                  >
                    {publication.user_id.image !== "default.png" && (
                      <img
                        src={publication.user_id.image}
                ...
                <div className="post__body">
                  <div className="post__user-info">
                    ...
                    >
                      {publication.user_id.name && publication.user_id.last_name
                        ? publication.user_id.name +
                          " " +
                          publication.user_id.last_name
                        : "Usuario Desconocido"}
                    </Link>
                  ...
                  {publication.file && (
                    <img
                      ...
                      className="post__image-publication"
                    />
                  )}
                </div>
              </div>
