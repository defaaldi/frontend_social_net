      ...
      <header className="aside__profile-info">
        ...
        <div className="profile-info__stats">
          <div className="stats__following">
            <Link
              to={"/rsocial/siguiendo/" + user._id}
              className="following__link"
            >
              <span className="following__title">Siguiendo</span>
              <span className="following__number">
                {counters.followingCount >= 1 ? counters.followingCount : 0}
              </span>
            </Link>
          </div>
          <div className="stats__following">
            <Link
              to={"/rsocial/seguidores/" + user._id}
              className="following__link"
            >
              <span className="following__title">Seguidores</span>
              <span className="following__number">
                {counters.followedCount >= 1 ? counters.followedCount : 0}
              </span>
            </Link>
          </div>
          ...
          <div className="stats__following">
            <Link
              to={"/rsocial/perfil/" + user._id}
              className="following__link"
            >
              <span className="following__title">Publicaciones</span>
              <span className="following__number">
                {counters.publicationsCount >= 1
